...
<head>
  ...
  <link href="https://cdn.datatables.net/v/bs4/jszip-3.10.1/dt-1.13.6/b-2.4.1/b-html5-2.4.1/b-print-2.4.1/r-2.5.0/datatables.min.css" rel="stylesheet">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <?php } else { ?>
          ...
          <ul class="menu-inner py-1">
            ...
            <ul class="menu-sub">
              <li class="">
                <a href="<?php echo base_url('pages/users'); ?>" class="menu-link">
                  <i class="menu-icon tf-icons bx bxs-user-detail"></i>&nbsp;&nbsp;
                  <div data-i18n="Analytics">User List</div>
                </a>
              </li>
              <li class="">
                <a href="<?php echo base_url('pages/addusers'); ?>" class="menu-link">
                  <i class="menu-icon tf-icons bx bxs-user-plus"></i>&nbsp;&nbsp;
                  <div data-i18n="Account">Add User</div>
                </a>
              </li>
              <li class="">
                <a href="<?php echo base_url('pages/account'); ?>" class="menu-link">
                  <i class="menu-icon tf-icons bx bxs-user-account"></i>&nbsp;&nbsp;
