...
<div class="layout-page">
	...
	<div class="content-wrapper">
				...
				<div class="col-lg-8 mb-4 order-0">
					<div class="card">
						<div class="d-flex align-items-end row">
							<div class="col-sm-7">
								<div class="card-body">
									<h5 class="card-title text-primary">Congratulations <?php echo $_SESSION['name']; ?>! 🎉</h5>
									<p class="mb-4">
						...
						<div class="col-6 mb-4">
							<div class="card">
								<div class="card-body">
									...
									<h3 class="card-title text-nowrap mb-2" id="pagenum">$2,456</h3>
		...
		<script type="text/javascript">
			// $.ajax({
			// 	url: "<?php// echo base_url() . 'sessions/timeout_session' ?>",
