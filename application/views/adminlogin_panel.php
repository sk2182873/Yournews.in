...
<div class="d-flex flex-column justify-content-center align-items-center bg-dark w-100">
    <div class="logo">
        <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
                ...
                <span class="app-brand-text demo menu-text fw-bolder ms-2">Your News</span>
            </a>
    ...
    <form class="mt-5" id="formAuthentication">
        <!-- Email input -->
        <div class="form-outline mb-1">
            <input type="email" id="form2Example1" name="email-username" class="form-control bg-dark text-light" value="<?php echo get_cookie('username'); ?>" />
            <label class="form-label text-light" for="form2Example1">Email address</label>
        </div>
        <p id="userErr" class="text-danger mb-4"></p>

        <!-- Password input -->
        <div class="form-outline mb-1">
            <input type="password" id="form2Example2" name="password" class="form-control bg-dark text-light" value="<?php echo get_cookie('password') ?>" />
            <label class="form-label text-light" for="form2Example2">Password</label>
        </div>
        <p id="passErr" class="text-danger mb-4"></p>
        ...
        <!-- Submit button -->
        <button type="submit" id="darkBtn" class="btn btn-light btn-block mb-4">Sign in</button>
